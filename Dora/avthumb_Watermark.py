...
base64_url = urlsafe_base64_encode('http://pia5c8gzf.bkt.clouddn.com/%E8%93%9D.png')
base64_txt = urlsafe_base64_encode('qiniu.com')
# 设置转码参数,利用format格式化函数传参
fops = 'avthumb/mp4/wmImage/{}/wmGravity/NorthEast/wmOffsetX/-2/wmOffsetY/-2/wmText/{}/wmGravityText/Center/wmFontSize/1/wmConstant/1'.format(base64_url,base64_txt)


# 通过添加'|saveas'参数，指定处理后的文件保存的bucket和key，不指定默认保存在当前空间，bucket_saved为目标bucket，name_saved为目标key
saveas_key = urlsafe_base64_encode('2018_11_16:test32')
